  ...
  <Step title="Make your first API call">
    ...
    curl -X POST https://zipkit.io/api/v1/zips \
      ...
      -d '{
        "urls": [
          {
            "url": "https://my-source-bucket.s3.amazonaws.com/file1.pdf",
            "filename": "document.pdf"
          },
          {
            "url": "https://my-source-bucket.s3.amazonaws.com/image.jpg",
            "filename": "image.jpg"
          },
          {
            "url": "https://my-source-bucket.s3.amazonaws.com/document.docx",
...
5. The zip is now available in your bucket at the `key` you specified (e.g., `my-archive.zip`)
