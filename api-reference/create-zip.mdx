...
curl -X POST https://zipkit.io/api/v1/zips \
  ...
  -d '{
    "urls": [
      {
        "url": "https://my-bucket.s3.amazonaws.com/documents/report.pdf",
        "filename": "report.pdf"
      },
      {
      ...
      {
        "url": "https://my-bucket.s3.amazonaws.com/data/spreadsheet.xlsx",
        "filename": "data.xlsx"
      }
    ],
...
curl_setopt($ch, CURLOPT_URL, 'https://zipkit.io/api/v1/zips');
...
public class CreateZip {
    public static void main(String[] args) throws Exception {
        String url = "https://zipkit.io/api/v1/zips";

        JSONArray urls = new JSONArray()
            .put(new JSONObject()
                .put("url", "https://my-bucket.s3.amazonaws.com/documents/report.pdf")
                .put("filename", "report.pdf"))
            .put(new JSONObject()
                .put("url", "https://my-bucket.s3.amazonaws.com/images/photo.jpg")
                .put("filename", "photo.jpg"))
            .put(new JSONObject()
                .put("url", "https://my-bucket.s3.amazonaws.com/data/spreadsheet.xlsx")
                .put("filename", "data.xlsx"));
        ...
        JSONObject data = new JSONObject()
            .put("urls", urls)
            .put("bucket_name", "my-destination-bucket")
            .put("key", "reports/monthly-2025-11.zip")
            .put("service", "s3")
...
**Common causes:**
- Missing required fields (`bucket_name`, `key`, or `urls`)
...
Returns plain text with 401 status code.
