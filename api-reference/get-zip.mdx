...
url = "https://zipkit.io/api/v1/zips/clx7g2m4p0000xyz123abc"
headers = {
...
const response = await fetch('https://zipkit.io/api/v1/zips/clx7g2m4p0000xyz123abc', {
  method: 'GET',
  headers: {
    'Authorization': 'Bearer your-access-token'
  }
...
curl_setopt($ch, CURLOPT_URL, 'https://zipkit.io/api/v1/zips/clx7g2m4p0000xyz123abc');
...
public class GetZip {
    public static void main(String[] args) throws Exception {
        String url = "https://zipkit.io/api/v1/zips/clx7g2m4p0000xyz123abc";
...
uri = URI('https://zipkit.io/api/v1/zips/clx7g2m4p0000xyz123abc')
